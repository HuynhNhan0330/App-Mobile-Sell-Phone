...
<div>
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td><button class="btn btn-success" style="height:40px"
                    onclick="customerView('<?=$row['id']?>')">Xem</button></td>
            <td><button class="btn btn-primary" style="height:40px"
                    onclick="variationEditForm('<?=$row['id']?>')">Sửa</button></td>
            <td><button class="btn btn-danger" style="height:40px"
                    onclick="customerDelete('<?=$row['id']?>')">Xoá</button></td>
        </tr>
        <?php
                    }
                }
